...
pub const Frame = struct {
    ...
    pub const payload_union = union(_payload_case) {
        ...
        pub const _desc_table = .{
            .@"error" = fd(30, .submessage),
            .client_daemon = fd(40, .submessage),
            .client_remote = fd(41, .submessage),
            .daemon_tunnel = fd(42, .submessage),
        };
    };

    pub const _desc_table = .{
        .attached = fd(20, .submessage),
        .payload = fd(null, .{ .oneof = payload_union }),
    };

    pub const Attached = struct {
        attached_bytes_len: u32 = 0,
        kind: Frame.Attached.Kind = @enumFromInt(0),
